...
if (empty($_SESSION['signed_in'])) {
    $tabTitle = 'Closedverse';
    printHeader('');
    echo '<div class="warning-content warning-content-forward"><div><strong>Welcome to Closedverse</strong><p>You must sign in to view this page.</p>
    ...
    if ($_SERVER['REQUEST_METHOD'] != 'POST') {
        ...
        $tabTitle = 'Profile Settings - Closedverse';
