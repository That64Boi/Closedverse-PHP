...
function sidebarSetting()
{
    ...
    echo '<div class="sidebar-setting sidebar-container">
		  <ul>
			...
			<li><a href="/settings/account" class="sidebar-menu-setting symbol"><span>Closedverse Settings</span></a></li>
			<li><a href="/titles/'.$announce['title_id'].'" class="sidebar-menu-info symbol"><span>Closedverse Announcements</span></a></li>
            <li><a href="/rules" class="sidebar-menu-guide symbol"><span>Closedverse Rules</span></a></li>
