    ...
    if ($user['user_level'] > 0) {
        if (isset($action)) {
            if ($action == 'delete_user') {
                ...
                $get_user->bind_param('i', $_POST['user_name']);
                $get_user->execute();
                $user_result = $get_user->get_result();
                if ($user_result->num_rows == 0) {
                    ...
                    if ($user['user_level'] > 0) {
                        ...
                        $delete_user = $dbc->prepare('DELETE FROM users WHERE user_name = ? LIMIT 1');
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="delete_user" action="/admin_panel/delete_user">
                                ...
                                <input class="form-control mb-2" type="text" name="user_id" placeholder="Username">
